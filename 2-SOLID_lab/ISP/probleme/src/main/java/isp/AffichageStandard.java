...
public class AffichageStandard implements AffichageDonneesVol {
    ...
    @Override
    public void onAppuiLongVol() {
        // non supporté
    }

    @Override
    public void executerCommande(String id, List<String> commandeArgs) {
        // non supporté
    }
}
